...
First thing I do is see what type of file this is using the command `file {file}`.
![[Pasted image 20251023155903.png]]
It only shows "data". What is weird is when I used cat on the file it showed this:
![[Pasted image 20251023160005.png]]We can see a lot of characters, but in the middle we see random data.
Also at the beginning of the file we see that it is a JFIF file.
![[Pasted image 20251023160051.png]]

I used the tool hexedit to see the file signature of the file. Since we knew it was a JFIF, and of course the first bytes were wrong.

![[Pasted image 20251023160540.png]] The correct bytes of a JFIF file are:
```
`FF D8 FF E0 00 10 4A 46   49 46 00 01`
```

Changing the first bytes to that and saving the file as .jpeg, we get this image.
