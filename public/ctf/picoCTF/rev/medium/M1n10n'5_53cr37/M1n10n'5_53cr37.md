...
They gives a .apk file
![[Pasted image 20251103154125.png]]
Since its an .apk file, lets use apktool to dissassemble this file.
![[Pasted image 20251103154245.png]]
![[Pasted image 20251103154401.png]]Now that we have all disassembled files, lets dig in.

I thought about going to see the file values/strings.xml because normally contains strings variables that were used on the app and fun enought we get a base32 encoded string
